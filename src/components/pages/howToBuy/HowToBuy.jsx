      ...
      <div className={styles.container}>
        ...
        <div className={styles.row}>
          <div className={styles.col1}>
            ...
            <br />
            <p>
              <b>1.</b> Dirígete a la sección de la tienda donde se encuentran
              todos los libros.
            </p>
            <br />
            <br />
            ...
            <br />
            <p>
              <b>3.</b> Explora los libros disponibles y haz clic sobre el que
              deseas comprar.
            </p>
            <br />
            <br />
            ...
            <br />
            <p>
              <b>8.</b> Si todo está correcto, selecciona el método de pago y
              procede a finalizar la compra.
            </p>
            <br />
            <br />
